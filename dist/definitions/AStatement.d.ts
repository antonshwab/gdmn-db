...
export declare abstract class AStatement<B extends ABlob = ABlob, RS extends AResultSet<B> = AResultSet<B>> {
     ...
     * </pre>
     */
    static executeQueryResultSet<R>(statement: AStatement, callback: TExecutor<AResultSet, R>): Promise<R>;
    /**
     * Example:
     * <pre>
     ...
     * </pre>
     */
    static executeQueryResultSet<R>(statement: AStatement, params: any[] | INamedParams, callback?: TExecutor<AResultSet, R>): Promise<R>;
    /**
