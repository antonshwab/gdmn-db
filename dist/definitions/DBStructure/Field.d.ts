...
export declare class Field {
    ...
    constructor(fieldType: FieldType, notNull: boolean, defaultValue: string | null, defaultSource: string | null, fieldLength: number, fieldScale: number, validationSource: string | null, fieldSubType: number | null, fieldPrecision: number);
}
